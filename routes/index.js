...
exports = module.exports = function (app) {
	...
	app.get('/authors/:author', routes.views.author);
	app.all('/join', routes.views.contact);
	...
	app.put('/api/posts/:id', keystone.middleware.api, routes.api.post.updatePostById);
